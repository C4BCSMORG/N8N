...
https://download.docker.com/linux/debian ${OS_CODENAME} stable" \
...
# simple, praxisnahe Validierung (http/https, Domain oder IPv4, optional Port/Pfad)
URL_REGEX='^https?://((([A-Za-z0-9-]+\.)+[A-Za-z]{2,})|((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])(\.(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])){3}))(:[0-9]+)?(/.*)?$'

while [[ ! "${N8N_URL}" =~ ${URL_REGEX} ]]; do
